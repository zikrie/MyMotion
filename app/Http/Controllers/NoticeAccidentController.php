...
class NoticeAccidentController extends CommonController
{
    ...
    public function index()
    {
        ...
        $state=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['state']);
        $idtype=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['idtype']);
        $race=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['race']);
        $national=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['national']);
        $mcsts=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['mcsts']);
        $transport=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['transport']);
        $accdplace=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['accdplace']);
        $accdwhen=DB::select('Select refcode, descen from reftable where tablerefcode=?', ['accdwhen']);
