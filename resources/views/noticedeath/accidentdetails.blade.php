<div class="tab-pane p-20" id="accident_details" role="tabpanel">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.place_accident')</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" style="width: 100%; height:36px;">
                                            ...
                                            <optgroup label="@lang('accidentDetails.in_premises')">
                                                ...
                                                <option value="DE">@lang('accidentDetails.attr.during_emergency')
                                                </option>
                                            ...
                                            <optgroup label="@lang('accidentDetails.out_premises')">
                                                ...
                                                <option value="DTT">@lang('accidentDetails.attr.during_tarvel_time')
                                                </option>
                                                <option value="DC">@lang('accidentDetails.attr.during_course')</option>
                                                <option value="DTR">@lang('accidentDetails.attr.during_travel_related')
                                                </option>
                                                <option value="DE">@lang('accidentDetails.attr.during_emergency')
                                                </option>
                                                <option value="others">@lang('accidentDetails.attr.others')</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="mode_transport" class="form-control">
                                    ...
                                    <input type="text" name="mode_transport_other" id="mode_transport_other"
                                        class="form-control" placeholder="">
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.causative_agent1')</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.industrial_code')</label>
                                        <input type="text" id="totalDay" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.employment_code')</label>
                                        <input type="text" id="totalDay" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.reason_travelling')</label>
                                        <textarea type="text" id="McStatus" class="form-control"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="totalDay" class="form-control"
                                            placeholder=""></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.start_workingTime')</label>
                                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                                            data-autoclose="true">
                                            <input type="text" class="form-control" value="00:00">
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            class="control-label">@lang('accidentDetails.attr.end_workingTime')</label>
                                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                                            data-autoclose="true">
                                            <input type="text" class="form-control" value="00:00">
                                            <div class="input-group-append">
...
{{-- <div class="col-md-6">
        <div class="form-group">
            <label>@lang('accidentDetails.attr.mode_transport')</label>
            <select name="mode_transport" class="form-control custom-select">
                <option>--Select your Transport--</option>
                <option>Bus</option>
                <option>Boat</option>
        ...
        <input type="text" name="mode_transport_other" id="mode_transport_other" class="form-control" placeholder="" >
    </div> --}}
