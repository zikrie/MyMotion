                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="leisure_ques1" name="leisure_ques" class="custom-control-input" required>
                                        <label class="custom-control-label" for="leisure_ques1">@lang('caseMgmt.attr.yes')</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="leisure_ques2" name="leisure_ques" class="custom-control-input" required>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="yes25" name="yes25" class="custom-control-input" required>
                                        <label class="custom-control-label" for="yes25">@lang('caseMgmt.attr.yes')</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="no25" name="yes25" class="custom-control-input" required>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="sport1" name="sport" class="custom-control-input" required>
                                        <label class="custom-control-label" for="sport1">@lang('caseMgmt.attr.yes')</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="sport2" name="sport" class="custom-control-input" required>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="social_activity1" name="social_activity" class="custom-control-input" required>
                                        <label class="custom-control-label" for="social_activity1">@lang('caseMgmt.attr.yes')</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="social_activity2" name="social_activity" class="custom-control-input" required>
