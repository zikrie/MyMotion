                        ...
                        <div class="row p-t-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control"  value="@if(!empty($data)){{ $data->name }} @endif" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="idNum" class="form-control"  value="{{session::get('idno')}}" >
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
